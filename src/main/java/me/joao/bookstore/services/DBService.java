...
public class DBService {
	...
	public void instanceBD() {
		...
		Livro l3 = new Livro("O ano em que a terra parou", "Luciano Trigo", "Lorem ipsum", cat3);
		Livro l4 = new Livro("Invasão Alien no Brasil", "Fransergio Soares", "Lorem ipsum", cat3);
		Livro l5 = new Livro("Javascript para iniciantes", "Pedro Baptista", "Lorem ipsum", cat1);
