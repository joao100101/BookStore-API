...
public class DBService {
	...
	public void instanceBD() {
		...
		Livro l2 = new Livro(null, "A História de Getúlio Vargas", "Arnaldo Romano", "Lorem ipsum Lorem ipsum",
				"Lorem ipsum", cat2);
		Livro l3 = new Livro(null, "O ano em que a terra parou", "Luciano Trigo", "Lorem ipsum Lorem ipsum",
				"Lorem ipsum", cat3);
		Livro l4 = new Livro(null, "Invasão Alien no Brasil", "Fransergio Soares", "Lorem ipsum Lorem ipsum",
				"Lorem ipsum", cat3);
		Livro l5 = new Livro(null, "Javascript para programadores impacientes", "Dr. Axel Rauschmayer",
